...
$toggl_api_key = 'fa66bce608f983e93649e6c2fbd385cc';
$toggl_api_version = 'v8';
$toggle_api_reporting_version = 'v2';

$username = 'vitezslav.dvorak@temify.com';
$password = 'p4ssw0rd';
...
$wid = 1961752; // Retrieve this with the get-workspaces.php file and update

//
//
//$clientdata = array('client' => array('name' => $client_name, 'wid' => $wid, 'notes' => $client_notes));
$response = $toggl_reports->monthly([
